                                             ...
                                             unsigned int n_total)
{
    ...
    const auto F_k_points = StructureFactorDirect::compute_F_k(
    ...
    if (query_points != nullptr)
    {
        const auto F_k_query_points
            = StructureFactorDirect::compute_F_k(query_points, n_query_points, n_total, m_k_points);
        S_k_all_points = StructureFactorDirect::compute_S_k(F_k_points, F_k_query_points);
    }
    else
    {
        S_k_all_points = StructureFactorDirect::compute_S_k(F_k_points, F_k_points);
    }
