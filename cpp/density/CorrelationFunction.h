...
public:
    ...
    void accumulate(const freud::locality::NeighborList* nlist, const freud::locality::NeighborQuery* nq,
                    const T* ref_values, unsigned int n_ref, const vec3<float>* points, const T* point_values,
