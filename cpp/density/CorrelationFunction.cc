    ...
    : BondHistogramCompute()
{
    ...
    unsigned int nbins = int(floorf(r_max / dr));
    ...
    axes.push_back(std::make_shared<util::RegularAxis>(nbins, 0, r_max));
    ...
    axes_rdf.push_back(std::make_shared<util::RegularAxis>(nbins, 0, r_max));
