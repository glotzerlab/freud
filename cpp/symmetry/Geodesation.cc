...
Geodesation::Geodesation(int iterations) {
    if (iterations < 1)
        throw invalid_argument("Geodesation requires at least 1 iteration.");
...
void Geodesation::geodesate() {
    ...
    for (int n = 0; n < (int) oldSimplexList->size(); n++) {
...
int Geodesation::getNVertices() {
    return m_vertexList->size();
}

int Geodesation::getNSimplices() {
...
// Vertex in between the vertices with indices i0 and i1
