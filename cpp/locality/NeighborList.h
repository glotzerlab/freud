...
//! Store a number of near-neighbor bonds from one set of positions (A, "reference points") to another set (B,
//! "target points")
...
public:
    ...
    //! Resize our member arrays to a larger size if given (always resize to exactly the given size if force
    //! is true)
