...
/*! The link-cell structure is not trivial to iterate over. This helper class makes that easier both in c++ and
    provides a python compatible interface for direct usage there.
    ...
    A loop over all of the particles in a cell can be accomplished with the following code in c++.
\code
