...
void PMFTXYT2D::compute(vec3<float> *ref_points,
    ...
    if (useCells())
        ...
        parallel_for(blocked_range<size_t>(0,Nref),
                     ComputePMFTXYT2DWithCellList(m_local_pcf_array,
                                                  m_nbins_x,
                                                  m_nbins_y,
                                                  m_nbins_T,
                                                  m_box,
        ...
        {
        parallel_for(blocked_range<size_t>(0,Nref),
                     ComputePMFTXYT2DWithoutCellList(m_local_pcf_array,
                                                     m_nbins_x,
                                                     m_nbins_y,
                                                     m_nbins_T,
                                                     m_box,
    ...
    parallel_for(blocked_range<size_t>(0,m_nbins_x), CombinePCFXYT2D(m_nbins_x,
                                                                     m_nbins_y,
                                                                     m_nbins_T,
                                                                     m_pcf_array.get(),
                                                                     m_local_pcf_array));
...
void PMFTXYT2D::computePy(boost::python::numeric::array ref_points,
