...
#ifndef _PMFTXYTM2D_H__
#define _PMFTXYTM2D_H__
...
class PMFTXYTM2D
    ...
    public:
        //! Constructor
        PMFTXYTM2D(float max_x, float max_y, float max_T, unsigned int nbins_x, unsigned int nbins_y, unsigned int nbins_T);
