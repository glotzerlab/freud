...
class ComputePMFTXYTP2DWithoutCellList
    ...
    public:
        ComputePMFTXYTP2DWithoutCellList(atomic<unsigned int> *pcf_array,
...
class ComputePMFTXYTP2DWithCellList
    ...
    private:
        ...
        const unsigned int m_Np;
    public:
        ComputePMFTXYTP2DWithCellList(atomic<unsigned int> *pcf_array,
                                unsigned int nbins_x,
                                unsigned int nbins_y,
                                unsigned int nbins_T,
                                const trajectory::Box &box,
...
void PMFTXYTP2D::compute(unsigned int *pcf_array,
                        float3 *ref_points,
                        float *ref_orientations,
                        unsigned int Nref,
                        float3 *points,
    ...
    if (useCells())
        ...
        parallel_for(blocked_range<size_t>(0,Nref), ComputePMFTXYTP2DWithCellList((atomic<unsigned int>*)pcf_array,
                                                                            m_nbins_x,
                                                                            m_nbins_y,
                                                                            m_nbins_T,
                                                                            m_box,
        ...
        {
        parallel_for(blocked_range<size_t>(0,Nref), ComputePMFTXYTP2DWithoutCellList((atomic<unsigned int>*)pcf_array,
                                                                               m_nbins_x,
                                                                               m_nbins_y,
                                                                               m_nbins_T,
                                                                               m_box,
...
void PMFTXYTP2D::computePy(boost::python::numeric::array pcf_array,
