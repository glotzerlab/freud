...
PMFTXYTP2D::PMFTXYTP2D(float max_x, float max_y, float max_T, unsigned int nbins_x, unsigned int nbins_y, unsigned int nbins_T)
...
void export_PMFTXYTP2D()
    {
    class_<PMFTXYTP2D>("PMFTXYTP2D", init<float, float, float, float, float, float>())
