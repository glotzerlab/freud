...
class ComputePMFTXYTP2DWithoutCellList
    ...
    public:
        ComputePMFTXYTP2DWithoutCellList(tbb::enumerable_thread_specific<unsigned int *>& pcf_array,
...
class ComputePMFTXYTP2DWithCellList
    ...
    private:
        ...
        const unsigned int m_Np;
    public:
        ComputePMFTXYTP2DWithCellList(tbb::enumerable_thread_specific<unsigned int *>& pcf_array,
                                      unsigned int nbins_x,
                                      unsigned int nbins_y,
                                      unsigned int nbins_T,
                                      const trajectory::Box &box,
