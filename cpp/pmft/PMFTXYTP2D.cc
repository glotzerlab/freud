...
PMFTXYTP2D::PMFTXYTP2D(float max_x, float max_y, unsigned int nbins_x, unsigned int nbins_y, unsigned int nbins_T)
...
class ComputePMFTXYTP2D
    ...
    public:
        ComputePMFTXYTP2D(tbb::enumerable_thread_specific<unsigned int *>& pcf_array,
...
boost::shared_array<unsigned int> PMFTXYTP2D::getPCF()
    {
    reducePCF();
    return m_pcf_array;
    }
...
// //! Get a reference to the PCF array
// boost::python::numeric::array PMFTXYTP2D::getPCFPy()
//     {
//     reducePCF();
...
void PMFTXYTP2D::accumulate(vec3<float> *ref_points,
                            float *ref_orientations,
                            unsigned int Nref,
                            vec3<float> *points,
                            float *orientations,
...
// void PMFTXYTP2D::accumulatePy(trajectory::Box& box,
...
// */
// void PMFTXYTP2D::computePy(trajectory::Box& box,
//                            boost::python::numeric::array ref_points,
//                            boost::python::numeric::array ref_orientations,
//                            boost::python::numeric::array points,
//                            boost::python::numeric::array orientations)
...
//     {
//     class_<PMFTXYTP2D>("PMFTXYTP2D", init<float, float, unsigned int, unsigned int, unsigned int>())
//         .def("getBox", &PMFTXYTP2D::getBox, return_internal_reference<>())
//         .def("accumulate", &PMFTXYTP2D::accumulatePy)
