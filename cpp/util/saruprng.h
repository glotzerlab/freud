...
template<> inline float Saru::s()
{
    return f();
}

template<> inline float Saru::s(float low, float high)
{
    return f(low, high);
}

template<> inline double Saru::s()
{
    return d();
}

template<> inline double Saru::s(double low, double high)
{
    return d(low, high);
}
