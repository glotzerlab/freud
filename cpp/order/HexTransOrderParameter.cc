                                               ...
                                               freud::locality::QueryArgs qargs)
{
    ...
    freud::locality::loopOverNeighborsIterator(
        points, points->getRefPoints(), Np, qargs, nlist,
...
HexOrderParameter::HexOrderParameter(unsigned int k) : HexTransOrderParameter<unsigned int>(k) {}
...
TransOrderParameter::TransOrderParameter(float k) : HexTransOrderParameter<float>(k) {}
...
void TransOrderParameter::compute(const freud::locality::NeighborList* nlist,
                                  ...
                                  freud::locality::QueryArgs qargs)
{
    computeGeneral([](vec3<float>& delta) { return std::complex<float>(delta.x, delta.y); }, nlist, points,
                   qargs);
}
