...
class Disks(Primitive):
    ...
    # \param positions Nx2 array listing the positions of each disk
    # \param diameters N array listing the diameters of each disk
    ...
    #
    # After initialization, the instance wil have members positions, diameters, and colors, each being a numpy
    # array of the appropriate size and dtype float32.
    #
