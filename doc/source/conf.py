...
exclude_patterns = [
    ...
    '_templates',
    '**.ipynb_checkpoints',
    'gettingstarted/examples/index.ipynb',
    'gettingstarted/examples/archive/**',
]
...
# of the sidebar.
html_logo = "images/freud_logo.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "images/freud_favicon.png"
...
latex_documents = [
    (master_doc, 'freud.tex', 'freud Documentation',
...
man_pages = [
    (master_doc, 'freud', 'freud Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'freud', 'freud Documentation',
     author, 'freud', 'One line description of project.',
     'Miscellaneous'),
]
