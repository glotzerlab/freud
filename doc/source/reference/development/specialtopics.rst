...
Some of the most central components in **freud** are quite complicated.
The details of these components are generally highly abstracted away, even from new module developers.
...
This documentation should help orient developers familiarizing themselves with these topics by providing a high-level overviews of how these parts of the code are structured and how the pieces fit together.
