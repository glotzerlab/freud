...
if(TBB_INCLUDE_DIR AND EXISTS "${TBB_INCLUDE_DIR}/tbb/tbb_stddef.h")
  file(STRINGS "${TBB_INCLUDE_DIR}/tbb/tbb_stddef.h" TBB_H
       REGEX "^#define TBB_VERSION_.*$")

  string(REGEX REPLACE ".*#define TBB_VERSION_MAJOR ([0-9]+).*$" "\\1"
                       TBB_VERSION_MAJOR "${TBB_H}")
  string(REGEX REPLACE "^.*TBB_VERSION_MINOR ([0-9]+).*$" "\\1"
                       TBB_VERSION_MINOR "${TBB_H}")
...
if(NOT TBB_USE_GLIBCXX_VERSION
  ...
  if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    # using Clang
    string(REPLACE "." "0" TBB_USE_GLIBCXX_VERSION
...
if(TBB_LIBRARY AND NOT TARGET TBB::tbb)
  ...
  set_target_properties(
    TBB::tbb
    PROPERTIES IMPORTED_LOCATION_RELEASE "${TBB_LIBRARY}"
               IMPORTED_LOCATION "${TBB_LIBRARY}"
               INTERFACE_INCLUDE_DIRECTORIES "${TBB_INCLUDE_DIR}")

  if(TBB_USE_GLIBCXX_VERSION)
    set_target_properties(
      TBB::tbb PROPERTIES INTERFACE_COMPILE_DEFINITIONS
                          "TBB_USE_GLIBCXX_VERSION=${TBB_USE_GLIBCXX_VERSION}")
  endif()
endif()
