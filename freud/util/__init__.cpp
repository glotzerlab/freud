...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "freud.util.__init__",
        "sources": [
            "freud/util/__init__.pyx",
            "cpp/box/box.cc",
    ...
    "module_name": "freud.util.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__freud__util____init__
#define __PYX_HAVE_API__freud__util____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'freud.util.__init__' */
#define __Pyx_MODULE_NAME "freud.util.__init__"
extern int __pyx_module_is_main_freud__util____init__;
int __pyx_module_is_main_freud__util____init__ = 0;

/* Implementation of 'freud.util.__init__' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_freud__util____init__) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely(__Pyx_SetPackagePathFromImportLib("freud", __pyx_n_u_util) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init freud.util.__init__", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init freud.util.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
