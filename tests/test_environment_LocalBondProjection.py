...
class TestLocalBondProjection(unittest.TestCase):
    ...
    def test_compute(self):
        ...
        npt.assert_allclose(ang.projections[2], 0, atol=1e-6)
        npt.assert_allclose(ang.normed_projections[2], 0, atol=1e-6)
        ...
        npt.assert_allclose(ang.projections[1], -1.5, atol=1e-6)
        ...
        npt.assert_allclose(ang.projections[2], 1, atol=1e-6)
