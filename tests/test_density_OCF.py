...
def test_summation():
    ...
    # This leads to vastly different results with different numbers of threads
    # if the summation is not done robustly
    N = 20000
    ...
    # With a small number of particles, we won't get the average exactly right,
    # so we check for different behavior with different numbers of threads
